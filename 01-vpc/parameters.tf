...
resource "aws_ssm_parameter" "publicsubnet" {
  ...
  type  = "StringList"
  value = join(",",module.vpc_infra.public_subnet_ids)
}
resource "aws_ssm_parameter" "dbsubnet" {

  name  = "/${var.project}/${var.environment}/db_subnet_ids"
  type  = "StringList"
  value = join(",",module.vpc_infra.db_subnet_ids)
}
resource "aws_ssm_parameter" "privatesubnet" {

  name  = "/${var.project}/${var.environment}/private_subnet_ids"
  type  = "StringList"
  value = join(",",module.vpc_infra.private_subnet_ids)
}



output "output_public_subnet_ids"  {
      value = module.vpc_infra.public_subnet_ids
}
output "vpc_id"  {
      value = module.vpc_infra.vpc_id
}
